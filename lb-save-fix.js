...
// The original page has inline onclick handlers. Those handlers can keep calling the old
// function declaration even after window.printReceipt is replaced. Capture the two
// final-action buttons so ONLY these buttons use the corrected save flow.
