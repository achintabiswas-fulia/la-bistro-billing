const CACHE='la-bistro-billing-v5';
...
self.addEventListener('fetch',e=>{
  ...
  if(u.pathname.endsWith('/index.html') || u.pathname.endsWith('/')){
    e.respondWith((async()=>{
      ...
      const inject='\n<script src="./lb-core.js?v=5"></script>\n<script src="./lb-manager.js?v=5"></script>\n<script src="./lb-cloud.js?v=5"></script>\n<script src="./lb-menu.js?v=5"></script>\n';
